...
class Twig extends \Twig_Environment {
  ...
  public function __construct() {
    ...
    $filter = new \Twig_SimpleFilter('htmltruncate',
  ...
  private function htmlTruncateFilter($html, $maxLength) {
    ...
    while ($printedLength < $maxLength && $this->mb_preg_match('{</?([a-z]+)[^>]*>|&#?[a-zA-Z0-9]+;}',
        $html, $match, PREG_OFFSET_CAPTURE, $position)) {
  ...
  private function mb_preg_match(
    ...
    $ret = preg_match($ps_pattern, $ps_subject, $pa_matches, $pn_flags,
      $pn_offset);
